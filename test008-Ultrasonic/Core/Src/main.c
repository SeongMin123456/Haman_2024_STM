...
#include <stdio.h>
#include "C:\Users\user\source\repos\STM32\myLib\ultrasonic.h"
...
//{
////	int t1 = htim2.Instance->CNT;	// Counter number = t1
//////	while((htim2.Instance->CNT - t1) <= us);
////	while(1)
////	{
////		if((htim2.Instance->CNT - t1) > us) break;
////	}  // 버그 가능성 있음 (Overflow 인근에서 저장 시에 오류)
//
...
int main(void)
{
  ...
  ProgramStart("Ultrasonic SR-04(SRF-05)");
